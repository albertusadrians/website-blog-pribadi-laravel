            ...
            @if ($posts[0]->image)
                <div style="max-height:400px; overflow:hidden">
                    <img src="{{ asset('storage/' . $posts[0]->image) }}" class="card-img-top"
                        alt="{{ $posts[0]->category->category_name }}">
                </div>
            @else
                <img src="https://source.unsplash.com/1200x400?{{ $posts[0]->category->category_name }}"
                    class="card-img-top" alt="{{ $posts[0]->category->category_name }}">
            @endif
                ...
                <p>
                    <small class="text-muted">
                        ...
                        <a class="text-decoration-none"
                            href="/posts?category={{ $posts[0]->category->category_slug }}">{{ $posts[0]->category->category_name }}</a>
                        ...
                        <div class="card">
                            ...
                            @else
                                <img src="https://source.unsplash.com/500x400?{{ $post->category->category_name }}"
                                    class="card-img-top" alt="{{ $post->category->category_name }}">
                            @endif
